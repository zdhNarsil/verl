...
export WANDB_API_KEY="cffb444ff810ce99dea5f502d75ded55b2b78198"
...
MODEL_PATH=${MODEL_PATH:-"/tos-bjml-prime/Qwen2.5-7B"}
CKPTS_DIR=${CKPTS_DIR:-"/fs-computility/prime/chenjiacheng/Scaling-PRIME/saved_model/test"}
TRAIN_FILE=${TRAIN_FILE:-"/tos-bjml-prime/dapo_data/dapo-math-1-modified.parquet"}
TEST_FILE=${TEST_FILE:-["/tos-bjml-prime/test/aime2425_olympiad.parquet"]}
